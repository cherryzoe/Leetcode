...
#   - be noted that we need to create a dummy node because as the end of merge we lose the new head. 
#     So dummy would be the best way to store the head and return.
